...
/* NOTE Gradient table to Scenes if lookup-table are more efficient than calculs
...
//  float grad = gradients1D[h];    // NOTE : AtlasTextureTest of Gradient look-up table instead of the above
